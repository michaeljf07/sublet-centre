        ...
        return (
            <div className="bg-white rounded-lg shadow p-6 text-center">
                ...
                <button
                    ...
                    className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 hover:cursor-pointer font-medium transition">
                    Create New Listing
                </button>
            </div>
        );
                    ...
                    <div
                        ...
                        <div className="flex flex-col sm:flex-row items-start justify-between gap-3 sm:gap-4">
                            <div className="flex-1 min-w-0">
                                <h4 className="text-base md:text-lg font-medium text-gray-900 line-clamp-1">
                                    {listing.title}
                                </h4>
                                <p className="mt-1 text-xs md:text-sm text-gray-600 line-clamp-1">
                                    {listing.address}
                                </p>
                                <div className="mt-3 flex flex-wrap items-center gap-2 md:gap-4 text-xs md:text-sm text-gray-600">
